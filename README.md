...
- **Important items.** A trailing `!` — `call the bank!`, `# Work!` — gives a row an accent bar and a heavier word. A mark and nothing more: it never reorders anything, and it stands down once the row is finished.
